...
class TestOauthRoutes:
    ...
    async def test_oauth_github(self, monkeypatch):
        ...
        # Mock database call
        mock_get_user = AsyncMock(return_value=fake_user_data)
        monkeypatch.setattr(UserRepository, "get_user", mock_get_user)
        ...
        expected_response = jwt.decode(response['token'], os.getenv("JWT_SECRET"), algorithms=["HS256"])
