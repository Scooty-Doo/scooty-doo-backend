...
WKTLineString = Annotated[
    ...
    Field(
        description="WKT LineString format with longitude (-180 to 180) and latitude (-90 to 90) coordinates",
...
WKTPolygon = Annotated[
    ...
    Field(
        description="WKT Polygon format with longitude (-180 to 180) and latitude (-90 to 90) coordinates",
        example="POLYGON((11.97 57.70, 11.98 57.70, 11.98 57.71, 11.97 57.71, 11.97 57.70))",
        json_schema_extra={
            "format": "WKT POLYGON",
            "examples": ["POLYGON((11.97 57.70, 11.98 57.70, 11.98 57.71, 11.97 57.71, 11.97 57.70))"]
        }
    )
]
