...
async def get_zones(
    ...
    collection_url = f"{base_url}/dev/zones"
...
async def get_zone_types(
    ...
    base_url = str(request.base_url).rstrip("/")
    collection_url = f"{base_url}/dev/zones/types"
...
async def get_zone(
    ...
    base_url = str(request.base_url).rstrip("/")
    resource_url = f"{base_url}/dev/zones/{zone_id}"
...
async def create_zone(
    ...
    base_url = str(request.base_url).rstrip("/")
    resource_url = f"{base_url}/dev/zones/{zone.id}"
...
async def create_zone_type(
    ...
    base_url = str(request.base_url).rstrip("/")
    resource_url = f"{base_url}/dev/zones/types/{zone_type.id}"
...
async def update_zone_type(
    ...
    base_url = str(request.base_url).rstrip("/")
    resource_url = f"{base_url}/dev/zones/types/{zone_type_id}"
