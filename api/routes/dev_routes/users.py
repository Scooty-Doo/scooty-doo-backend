...
async def get_user(
    ...
    resource_url = f"{base_url}/dev/users/{user_id}"
...
async def get_users(
    ...
    base_url = str(request.base_url).rstrip("/")
    collection_url = f"{base_url}/dev/users"
...
async def create_user(
    ...
    base_url = str(request.base_url).rstrip("/")
    resource_url = f"{base_url}/dev/users/{user.id}"
...
async def get_user_trips(
    ...
    base_url = str(request.base_url).rstrip("/")
    resource_url = f"{base_url}/dev/users/{user_id}/trips"
...
async def get_user_transactions(
    ...
    base_url = str(request.base_url).rstrip("/")
    resource_url = f"{base_url}/dev/users/{user_id}/transactions"
