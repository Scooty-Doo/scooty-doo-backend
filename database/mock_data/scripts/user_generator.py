...
def clean_string(input_str: str) -> str:
    """Clean string by replacing special characters with their base letter and removing non-alphanumeric characters."""
...
def generate_user_data(female_names: List[str], male_names: List[str], last_names: List[str], user_id: int) -> dict:
...
def generate_users(num_users: int, output_path: str, female_path: str, male_path: str, last_name_path: str):
    ...
    with open(output_path, 'w', newline='') as f:
        ...
        for user_id in range(4, num_users + 1):
