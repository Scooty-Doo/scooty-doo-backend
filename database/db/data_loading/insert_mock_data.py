...
with psycopg.connect(**db_params) as conn, conn.cursor() as cur:
    ...
    with open(cities_file_path) as csvfile:
    ...
    # Insert users
    with open(users_file_path) as csvfile:
    ...
    with open(payment_providers_file_path) as jsonfile:
    ...
    with open(bike_status_file_path) as jsonfile:
    ...
    # Insert bikes
    with open(bike_file_path) as csvfile:
    ...
    with open(bike_2_status_file_path) as csvfile:
    ...
    with open(trip_file_path) as csvfile:
    ...
    with open(zone_types_file_path) as csvfile:
    ...
    with open(map_zones_file_path) as csvfile:
    ...
    with open(admin_file_path) as csvfile:
        admin_reader = csv.DictReader(csvfile)
        admin_data = [(row["id"], row["full_name"], row["email"]) for row in admin_reader]
    ...
    with open(admin_roles_file_path) as csvfile:
        admin_roles_reader = csv.DictReader(csvfile)
        admin_roles_data = [(row["id"], row["role_name"]) for row in admin_roles_reader]
    ...
    with open(admin_to_roles_file_path) as csvfile:
        admin_to_roles_reader = csv.DictReader(csvfile)
        admin_to_roles_data = [(row["admin_id"], row["role_id"]) for row in admin_to_roles_reader]
